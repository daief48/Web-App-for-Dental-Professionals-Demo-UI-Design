...
const MobileContainer = ({ children }) => {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-0 sm:p-4 md:p-8 transition-colors duration-500 ${
      theme === 'light' ? 'theme-light bg-slate-200/50' : 'theme-dark bg-black'
    }`}>
      {/* Mobile Device Emulator Container */}
      <div className={`relative w-full h-screen sm:h-[850px] sm:max-h-[90vh] sm:w-[400px] sm:rounded-[3rem] overflow-hidden bg-background shadow-2xl sm:border-[8px] transition-colors duration-500 flex flex-col ${
